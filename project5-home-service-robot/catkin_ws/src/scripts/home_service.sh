...
sleep 5
gnome-terminal  -- bash -c "cd ${catkin_ws_path} && source devel/setup.bash && rosrun add_markers add_markers" &
sleep 2
gnome-terminal  -- bash -c "cd ${catkin_ws_path} && source devel/setup.bash && rosrun pick_objects pick_objects"