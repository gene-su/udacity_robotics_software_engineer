...
sleep 5
gnome-terminal  -- bash -c "source /home/$USER/project5-home-service-robot/catkin_ws/devel/setup.bash && rosrun add_markers add_markers" &
sleep 2
gnome-terminal  -- bash -c "source /home/$USER/project5-home-service-robot/catkin_ws/devel/setup.bash && rosrun pick_objects pick_objects"